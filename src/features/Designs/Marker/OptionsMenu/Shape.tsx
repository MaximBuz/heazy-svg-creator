    ...
    <>
      ...
      <HStack>
        <SliderIconWrapper
          viewBox={'0 0 297 297'}
          onClick={() =>
            state.strokeWidth > 0 && setState((prev) => ({ ...prev, strokeWidth: prev.strokeWidth - 10 }))
          }
        >
          <ThickLeft />
        </SliderIconWrapper>
        ...
        <SliderIconWrapper
          viewBox={'0 0 374 374'}
          onClick={() =>
            state.strokeWidth < 200 && setState((prev) => ({ ...prev, strokeWidth: state.strokeWidth + 10 }))
          }
        >
          <ThickRight />
        </SliderIconWrapper>
      ...
      <HStack>
        <SliderIconWrapper
          viewBox={'0 0 356 124'}
          onClick={() =>
            state.markerHeight > 0 && setState((prev) => ({ ...prev, markerHeight: prev.markerHeight - 5 }))
          }
        >
          <HeightLeft />
        </SliderIconWrapper>
        ...
        <Slider
          ...
          min={1}
          max={50}
          onChange={(val) => setState((prev) => ({ ...prev, markerHeight: val }))}
        >
          <SliderTrack>
            <SliderFilledTrack />
          </SliderTrack>
        ...
        <SliderIconWrapper
          viewBox={'0 0 344 396'}
          onClick={() =>
            state.markerHeight < 50 && setState((prev) => ({ ...prev, markerHeight: prev.markerHeight + 5 }))
          }
        >
          <HeightRight />
        </SliderIconWrapper>
      ...
      <HStack>
        <SliderIconWrapper
          viewBox={'0 0 238 270'}
          onClick={() =>
            state.zickZacks > 0 && setState((prev) => ({ ...prev, zickZacks: prev.zickZacks - 1 }))
          }
        >
          <ZigZagLeft />
        </SliderIconWrapper>
        ...
        <SliderIconWrapper
          viewBox={'0 0 426 266'}
          onClick={() =>
            state.zickZacks < 40 && setState((prev) => ({ ...prev, zickZacks: prev.zickZacks + 1 }))
          }
        >
          <ZigZagRight />
        </SliderIconWrapper>
      ...
      <HStack>
        <SliderIconWrapper
          viewBox={'0 0 188 297'}
          onClick={() =>
            state.pressure > -10 && setState((prev) => ({ ...prev, pressure: prev.pressure - 1 }))
          }
        >
          <PressureRight />
        </SliderIconWrapper>
      ...
      <Tabs
        onChange={(index) =>
          setState((prev) => ({ ...prev, lineCap: index === 0 ? 'butt' : index === 1 ? 'round' : 'square' }))
        }
        defaultIndex={state.lineCap === 'butt' ? 0 : state.lineCap === 'round' ? 1 : 2}
        isFitted
        variant="unstyled"
      >
        <TabList>
      ...
      <Tabs
        onChange={(index) =>
          setState((prev) => ({ ...prev, lineJoin: index === 0 ? 'bevel' : index === 1 ? 'round' : 'miter' }))
        }
        defaultIndex={state.lineJoin === 'bevel' ? 0 : state.lineJoin === 'round' ? 1 : 2}
        isFitted
        variant="unstyled"
      >
        <TabList>
