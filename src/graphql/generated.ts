...
export type UserByFirebaseIdQuery = {
  __typename?: 'Query';
  getUserByFirebaseId?: {
    __typename?: 'User';
    id: number;
    ...
    corners?: Array<{
      ...
      distance: number;
      smooth: number;
      topLeftCorner?: boolean | null;
      topRightCorner?: boolean | null;
      bottomLeftCorner?: boolean | null;
      bottomRightCorner?: boolean | null;
      mirror?: boolean | null;
      startColor: string;
      endColor: string;
      bgColor: string;
...
export const UserByFirebaseIdDocument = `
  ...
  getUserByFirebaseId(id: $id) {
    ...
    `;
export const useUserByFirebaseIdQuery = <TData = UserByFirebaseIdQuery, TError = unknown>(
  ...
  useQuery<UserByFirebaseIdQuery, TError, TData>(
    ...
    fetcher<UserByFirebaseIdQuery, UserByFirebaseIdQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      UserByFirebaseIdDocument,
      variables
    ),
    options
  );
